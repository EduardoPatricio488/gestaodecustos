            ...
            htmlString: "
                <div style='font-family:Arial,Helvetica,sans-serif;background:#f4f4f5;padding:40px;color:#18181b;'>
                    <div style='max-width:620px;margin:0 auto;background:#fff;padding:36px;border-radius:24px;border:1px solid #e4e4e7;'>
                        ...
                        <p style='font-size:15px;line-height:1.7;'>Olá <strong>{$this->client->name}</strong>, a empresa <strong>{$this->workspace->legal_name ?: $this->workspace->name}</strong> disponibilizou-te acesso ao portal de cliente.</p>
                        <div style='background:#ecfdf5;border:1px solid #a7f3d0;border-radius:18px;padding:22px;margin:24px 0;'>
                            ...
                            <div style='font-size:32px;font-weight:900;letter-spacing:6px;color:#065f46;font-family:monospace;margin-top:8px;'>{$this->token}</div>
                        </div>
                        <p style='font-size:14px;line-height:1.7;'>Utiliza este código no portal para autenticar o teu acesso.</p>
                        <p style='margin:28px 0;'><a href='{$this->portalUrl}' style='display:inline-block;background:#059669;color:#fff;text-decoration:none;padding:14px 22px;border-radius:12px;font-weight:800;'>Abrir portal de cliente</a></p>
