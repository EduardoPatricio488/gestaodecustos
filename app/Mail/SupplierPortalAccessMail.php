...
class SupplierPortalAccessMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Acesso ao portal de fornecedor — '.($this->workspace->legal_name ?: $this->workspace->name),
        );
    }
    ...
    public function content(): Content
    {
        ...
        $supplierName = e($this->supplier->name);
            ...
            htmlString: "
                <div style='font-family:Arial,Helvetica,sans-serif;background:#f4f4f5;padding:40px;color:#18181b;'>
                    <div style='max-width:620px;margin:0 auto;background:#fff;padding:36px;border-radius:24px;border:1px solid #e4e4e7;'>
                        ...
                        <p style='font-size:15px;line-height:1.7;'>Olá <strong>{$supplierName}</strong>, a empresa <strong>{$companyName}</strong> disponibilizou-te acesso ao portal de fornecedor.</p>
                        ...
                        <p style='margin:28px 0;'><a href='{$portalUrl}' style='display:inline-block;background:#059669;color:#fff;text-decoration:none;padding:14px 22px;border-radius:12px;font-weight:800;'>Abrir portal de fornecedor</a></p>
