...
public function applyRaise()
{
    ...
    public function saveFixed()
    {
        ...
        $this->validate([
            ...
            'recTaxEstimate'  => 'nullable|numeric|min:0|max:100',
            'recNotes'        => 'nullable|string|max:500',
        ]);
        ...
        $this->reset(['recDescription', 'recAmount', 'recDay', 'recTaxEstimate', 'recNotes']);
    ...
    public function editFixed($id)
    {
        ...
        $this->dispatch('open-fixed-modal');
    }
    ...
    public function updateFixed()
    {
        ...
        $this->recSource = 'emprego';
        $this->recFrequency = 'mensal';
        $this->dispatch('close-fixed-modal');
    ...
    public function render()
    {
        ...
        // Total anual inclui salário fixo * meses decorridos no ano
        ...
        // Imposto estimado total este mês
