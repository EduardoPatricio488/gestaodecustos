   ...
   private function setHubConfig(): void
{
    ...
    $category = \App\Models\Category::where('workspace_id', auth()->user()->current_workspace_id)
   ...
   public function render()
{
    ...
    return view('livewire.category-hub', [
        ...
        'canManage'      => !$user->isViewer(), // <--- ADICIONADO: Resolve o Erro 500
        'isOwner'        => $user->isOwner(),   // <--- ADICIONADO: Resolve o Erro 500
    ]);
}
}
