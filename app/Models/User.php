...
public function sendEmailVerificationNotification()
{
    ...
    public function isStar(): bool { return ($this->currentWorkspace->plan ?? 'free') === 'plus'; }
    public function isDiamond(): bool { return in_array($this->currentWorkspace->plan ?? 'free', ['pro', 'company']); }
