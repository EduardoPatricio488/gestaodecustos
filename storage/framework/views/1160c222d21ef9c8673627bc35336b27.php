...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="meta-data">
                Espaço: <strong><?php echo e($workspaceName); ?></strong><br>
                Protocolo: <strong>#<?php echo e(date('Ymd')); ?>-<?php echo e(rand(100,999)); ?></strong><br>
                Período: <?php echo e($start); ?> — <?php echo e($end); ?>
        ...
        <table class="summary-table">
            <tr>
                <td class="card c-green" width="33%">
                    ...
                    <div class="card-value">+<?php echo e(number_format($totalIncomes, 2, ',', ' ')); ?>€</div>
                </td>
                <td class="card c-red" width="33%">
                    <div class="card-label">Volume de Saídas</div>
                    <div class="card-value">-<?php echo e(number_format($totalExpenses, 2, ',', ' ')); ?>€</div>
                </td>
                <td class="card c-indigo" width="33%">
                    <div class="card-label">Cash Flow Líquido</div>
                    <div class="card-value"><?php echo e(number_format($totalIncomes - $totalExpenses, 2, ',', ' ')); ?>€</div>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="data-grid">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="badge"><?php echo e($e->category->name ?? 'Geral'); ?></span></td>
                <td><?php echo e($e->description ?: 'Registo operacional sem descrição'); ?></td>
                <td class="amount neg">-<?php echo e(number_format($e->amount, 2, ',', ' ')); ?>€</td>
            </tr>
    ...
    <table class="data-grid">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e(\Carbon\Carbon::parse($i->received_at)->format('d/m/Y')); ?></td>
                <td><strong><?php echo e($i->title ?? 'Rendimento'); ?></strong></td>
                <td class="amount pos">+<?php echo e(number_format($i->amount, 2, ',', ' ')); ?>€</td>
            </tr>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </tbody>
    </table>
    ...
    <footer>
        Documento gerado em <?php echo e($generatedAt); ?> via Protocolo Finance Pro IA. <br>
        <strong>Confidencial</strong> — Apenas para uso interno do Workspace <?php echo e($workspaceName); ?>.
    </footer>

</body>
</html>
<?php /**PATH C:\Projetos\gestao-de-custos\resources\views\pdf\financial-report.blade.php ENDPATH**/ ?>