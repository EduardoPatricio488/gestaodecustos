        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="group relative bg-zinc-50 border border-zinc-200 rounded-[2.5rem] overflow-hidden flex flex-col hover:border-brand-500 hover:shadow-xl transition-all" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'product-'.e($product->id).''; ?>wire:key="product-<?php echo e($product->id); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($product->id, $ownedProductIds)): ?>
...
<?php endif; ?>
                    ...
                    <div class="p-6 flex flex-col flex-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->requires_business_plan): ?>
                            <span class="mt-2 inline-flex w-fit items-center gap-1 rounded-full bg-amber-100 px-2 py-1 text-[8px] font-black uppercase tracking-widest text-amber-800">
                                <?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'building-office-2','class' => 'size-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'building-office-2','class' => 'size-3']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                        ...
                        <div class="mt-auto pt-4 flex items-center justify-between border-t border-zinc-200 mt-4">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <button wire:click="addToCart(<?php echo e($product->id); ?>)"
                                        class="px-3 py-2 <?php echo e($product->requires_business_plan && ! $hasBusinessPlan ? 'bg-zinc-400 hover:bg-zinc-500' : 'bg-zinc-200 hover:bg-zinc-300'); ?> rounded-xl text-[9px] font-black uppercase <?php echo e($product->requires_business_plan && ! $hasBusinessPlan ? 'text-white' : ''); ?>">
                                    <?php echo e($product->requires_business_plan && ! $hasBusinessPlan ? 'Business' : (in_array($product->id, $ownedProductIds) ? 'Comprar de novo' : '+ Carrinho')); ?>

                                </button>
                                <button wire:click="buyNow(<?php echo e($product->id); ?>)"
                                        class="px-3 py-2 <?php echo e($product->requires_business_plan && ! $hasBusinessPlan ? 'bg-zinc-500 hover:bg-zinc-600' : 'bg-brand-600 hover:bg-brand-700'); ?> text-white rounded-xl text-[9px] font-black uppercase">
                                    <?php echo e($product->requires_business_plan && ! $hasBusinessPlan ? 'Requer Business' : 'Comprar'); ?>
