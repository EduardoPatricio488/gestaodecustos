...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                <label class="text-[10px] font-black uppercase tracking-widest text-zinc-500">
                    IVA (<?php echo e(strtoupper($currency)); ?>)
                </label>
                <input
                    type="number"
                    step="0.01"
            ...
            <div>
                <label class="text-[10px] font-black uppercase tracking-widest text-zinc-500">
                    Total (<?php echo e(strtoupper($currency)); ?>)
                </label>
                <input
                    type="number"
                    step="0.01"
            ...
            <p class="text-[10px] text-zinc-500 font-bold">
                Conversão automática para <?php echo e($workspaceCurrency); ?> aplicada ao guardar.
            </p>
...
</div><?php /**PATH C:\Projetos\gestao-de-custos\resources\views\livewire\business\partials\invoice-modal.blade.php ENDPATH**/ ?>