...
<?php endif; ?>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-5 shadow-sm">
            ...
            <p class="text-2xl font-black text-emerald-600 italic tabular-nums"><?php echo e(number_format($monthSummary['income'], 0, ',', '.')); ?>â‚¬</p>
        </div>
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-5 shadow-sm">
            <p class="text-[9px] font-black uppercase tracking-widest text-zinc-400 mb-2">Saidas previstas</p>
            <p class="text-2xl font-black text-red-500 italic tabular-nums"><?php echo e(number_format($monthSummary['outflow'], 0, ',', '.')); ?>â‚¬</p>
        </div>
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-5 shadow-sm">
            <p class="text-[9px] font-black uppercase tracking-widest text-zinc-400 mb-2">Vencimentos fixos</p>
            <p class="text-2xl font-black text-amber-500 italic tabular-nums"><?php echo e(number_format($monthSummary['fixed_outflow'], 0, ',', '.')); ?>â‚¬</p>
        </div>
        <div class="bg-zinc-950 text-white border border-zinc-800 rounded-3xl p-5 shadow-xl">
            ...
            <p class="text-[9px] text-zinc-500 mt-1">saldo final <?php echo e(number_format($monthSummary['projected_balance'], 0, ',', '.')); ?>â‚¬</p>
        </div>
    </div>
...
</div><?php /**PATH C:\Projetos\gestao-de-custos\resources\views\livewire\personal-calendar.blade.php ENDPATH**/ ?>