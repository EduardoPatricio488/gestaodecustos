...
<head>
    ...
    <title>Manutenção | <?php echo e(config('app.name')); ?></title>
...
<body class="bg-zinc-950 text-zinc-200 antialiased flex items-center justify-center min-h-screen p-6 overflow-hidden">
    ...
    <div class="absolute bottom-10 text-center w-full">
        <p class="text-[9px] text-zinc-700 font-black uppercase tracking-[0.3em]">
            &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> · Gestão de Custos Inteligente
        </p>
    </div>

</body>
</html>
<?php /**PATH C:\Projetos\gestao-de-custos\resources\views\errors\maintenance.blade.php ENDPATH**/ ?>