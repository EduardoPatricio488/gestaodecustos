...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.trigger','data' => ['name' => 'add-invoice-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'add-invoice-modal']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::select.index','data' => ['wire:model.live' => 'statusFilter','class' => 'w-40 text-[10px] font-black uppercase tracking-widest !bg-transparent border-none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'statusFilter','class' => 'w-40 text-[10px] font-black uppercase tracking-widest !bg-transparent border-none']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <h3 class="text-4xl font-black text-emerald-600 tracking-tighter">
                <?php echo e(number_format($totalBilled, 2, ',', ' ')); ?> <?php echo e($workspaceCurrency); ?>
...
<?php endif; ?>
            ...
            <h3 class="text-4xl font-black text-amber-600 tracking-tighter">
                <?php echo e(number_format($totalPending, 2, ',', ' ')); ?> <?php echo e($workspaceCurrency); ?>
        ...
        <div class="relative bg-zinc-950 p-8 rounded-[2.5rem] border border-zinc-800 shadow-2xl overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <h3 class="text-4xl font-black text-white tracking-tighter italic">
                    <?php echo e(number_format($vatToPay, 2, ',', ' ')); ?> <?php echo e($workspaceCurrency); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <?php echo e($invoices->total()); ?> Documentos
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4cc377eda9b63b796b6668ee7832d023)): ?>
<?php $attributes = $__attributesOriginal4cc377eda9b63b796b6668ee7832d023; ?>
                        ...
                        <tr class="hover:bg-zinc-50 dark:hover:bg-brand-500/5 transition-all group/row">
                            ...
                            <td class="p-6">
                                <div class="flex flex-col">
                                    <span class="text-sm font-black uppercase dark:text-white">#<?php echo e($inv->invoice_number); ?></span>
                                    <span class="text-[10px] text-zinc-500 font-bold uppercase"><?php echo e($inv->client_name); ?></span>
                                </div>
                            </td>

                            
                            <td class="p-6 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inv->status === 'paga'): ?>
                            ...
                            <td class="p-6">
                                <span class="text-xs font-bold <?php echo e($isOverdue ? 'text-red-500' : 'text-zinc-600 dark:text-zinc-400'); ?>">
                            ...
                            <td class="p-6 text-right px-10">
                                <span class="text-xl font-black <?php echo e($inv->status === 'paga' ? 'text-emerald-600' : 'text-zinc-900 dark:text-white'); ?> italic">
                                    <?php echo e(number_format($inv->total_amount, 2, ',', ' ')); ?> <?php echo e(strtoupper($inv->currency ?? $workspaceCurrency)); ?>

                                </span>
                                <span class="text-[8px] font-black text-zinc-400 uppercase opacity-70">
                                    Base: <?php echo e(number_format($inv->amount_excl_vat, 2, ',', ' ')); ?> <?php echo e(strtoupper($inv->currency ?? $workspaceCurrency)); ?>

                                </span>
                                <span class="block text-[8px] font-black text-brand-600 uppercase opacity-80">
                                    Conv.: <?php echo e(number_format($inv->total_amount_converted ?? $inv->total_amount, 2, ',', ' ')); ?> <?php echo e($workspaceCurrency); ?>
                            ...
                            <td class="p-6 text-right pr-8">
                                <div class="flex items-center gap-2 opacity-0 group-hover/row:opacity-100 transition-opacity">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inv->status === 'pendente'): ?>
                                        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'markAsPaid('.e($inv->id).')','variant' => 'ghost','icon' => 'check','size' => 'xs','color' => 'emerald','class' => 'rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'markAsPaid('.e($inv->id).')','variant' => 'ghost','icon' => 'check','size' => 'xs','color' => 'emerald','class' => 'rounded-lg']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'delete('.e($inv->id).')','wire:confirm' => 'Eliminar registo de venda?','variant' => 'ghost','icon' => 'trash','size' => 'xs','color' => 'red','class' => 'rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'delete('.e($inv->id).')','wire:confirm' => 'Eliminar registo de venda?','variant' => 'ghost','icon' => 'trash','size' => 'xs','color' => 'red','class' => 'rounded-lg']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                            ...
                            <td colspan="5" class="p-24 text-center">
                                <div class="flex flex-col items-center gap-4">
                                    <div class="p-8 bg-zinc-50 dark:bg-zinc-900 rounded-[3rem] border-2 border-dashed border-zinc-200 dark:border-zinc-800 shadow-inner">
                                        <?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'newspaper','class' => 'size-12 text-zinc-200 dark:text-zinc-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'newspaper','class' => 'size-12 text-zinc-200 dark:text-zinc-700']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('livewire.business.partials.invoice-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    
    <footer class="pt-20 pb-6 text-center border-t border-zinc-100 dark:border-zinc-800 mt-20">
        <p class="text-[9px] font-black text-zinc-400 uppercase tracking-[0.4em]">
            © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> · Terminal de Faturação e Vendas
        </p>
    </footer>

</div><?php /**PATH C:\Projetos\gestao-de-custos\resources\views\livewire\business\invoicing-hub.blade.php ENDPATH**/ ?>