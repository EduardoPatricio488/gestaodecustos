...
<?php if (! $__env->hasRenderedOnce('a1482169-7f3f-46f1-ae73-4f6a2f9e8244')): $__env->markAsRenderedOnce('a1482169-7f3f-46f1-ae73-4f6a2f9e8244'); ?>
<style>
...
<?php endif; ?>
    ...
    <p class="text-sm font-black text-zinc-900 uppercase tracking-tight truncate"><?php echo e($user->name); ?></p>
    <p class="text-[9px] text-zinc-400 font-bold tracking-widest">
        <span class="text-emerald-500">@</span><?php echo e($user->username); ?>
...
<?php /**PATH C:\Projetos\gestao-de-custos\resources\views/livewire/social/chat-panel.blade.php ENDPATH**/ ?>