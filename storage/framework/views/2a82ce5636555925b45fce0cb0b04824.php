...
<?php endif; ?>
 ...
 <img src="<?php echo e(asset($workspace->logo_path)); ?>?t=<?php echo e(time()); ?>" class="size-24 rounded-[2.5rem] shadow-2xl border-4 border-white dark:border-zinc-800 object-cover bg-white">                    <div class="absolute -bottom-1 -right-1 size-7 bg-emerald-500 border-4 border-zinc-50 dark:border-zinc-950 rounded-full shadow-lg"></div>
                </div>
...
</div><?php /**PATH C:\Projetos\gestao-de-custos\resources\views\livewire\business\business-dashboard.blade.php ENDPATH**/ ?>