...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1 style="font-style: italic; letter-spacing: -1px;">Olá, <?php echo e(auth()->user()->name); ?>!</h1>
            <p>Parabéns! Acabaste de ativar o ecossistema empresarial para a <strong><?php echo e($workspace->name); ?></strong>.</p>
            ...
            <p>O capital inicial registado foi de: <strong><?php echo e(number_format($workspace->initial_capital, 2)); ?>€</strong>.</p>

            <a href="<?php echo e(route('hub.business.dashboard')); ?>" class="btn">Entrar no Terminal Business</a>
        </div>
        <div class="footer">
            © <?php echo e(date('Y')); ?> Finance Pro IA · Gestão Profissional de Ativos
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Projetos\gestao-de-custos\resources\views/emails/welcome-business.blade.php ENDPATH**/ ?>