...
use App\Livewire\Admin\{AdminDashboard, UserManagement, SupportManager, GlobalLogs, SiteSettings};
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/hub/dynamic/{slug}', CategoryHub::class)->name('hub.dynamic');
