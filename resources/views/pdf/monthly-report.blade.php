...
<body>
    <div class="header">
        ...
        <p style="margin:6px 0 0;" class="muted">{{ $monthName }} / {{ $year }}</p>
    </div>
    ...
    <table class="kpi-grid">
        <tr>
            <td>
                ...
                <div class="kpi-value">{{ number_format($earned, 2, ',', '.') }} €</div>
            </td>
            <td>
                <div class="kpi-label">Gastos</div>
                <div class="kpi-value">{{ number_format($spent, 2, ',', '.') }} €</div>
            </td>
            <td>
    ...
    <p class="muted" style="margin-top:18px;">Gerado automaticamente por {{ config('app.name') }} em {{ now()->format('d/m/Y H:i') }}.</p>
</body>
</html>
