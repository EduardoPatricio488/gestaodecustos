...
{{-- ══════════════════════════════════════════════
     CABEÇALHO
══════════════════════════════════════════════ --}}
<div class="flex items-center justify-between gap-4 pt-6 md:pt-8 pb-1">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-[1.6rem] font-black italic tracking-tight text-zinc-900 leading-none">Finance Connect</h1>
            <p class="text-[9px] font-bold uppercase tracking-[.2em] text-zinc-400 mt-0.5">Rede de Progresso Financeiro</p>
        </div>
    </div>
...
<div class="mt-4 relative">
    <flux:icon name="magnifying-glass" class="size-4 text-zinc-400 absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none z-10" />
    <input
        type="search"
        wire:model.live.debounce.350ms="search"
        placeholder="Pesquisar posts ou #hashtags..."
        class="fc-input w-full py-3.5 pl-11 pr-10"
    >
    @if($search !== '')
        <button wire:click="$set('search', '')"
            class="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-700 transition-colors">
...
{{-- ══════════════════════════════════════════════
     TABS
══════════════════════════════════════════════ --}}
<div class="flex items-center gap-2 mt-3.5 overflow-x-auto no-scrollbar pb-1">
