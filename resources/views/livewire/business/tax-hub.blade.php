<div class="space-y-10 pb-24">
    ...
    <div class="relative">
        ...
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative z-10 px-2">
            <div class="flex items-center gap-6">
                ...
                <div>
                    <div class="flex items-center gap-3">
                        <h1 class="text-4xl font-black dark:text-white uppercase tracking-tighter italic leading-none text-zinc-900 dark:text-white">Impostos & Obrigações</h1>
                        <flux:badge variant="neutral" class="bg-amber-500/10 text-amber-600 text-[9px] font-black uppercase tracking-widest border-none px-3 py-1">Fiscalidade Ativa</flux:badge>
                    </div>
                    <p class="text-sm text-zinc-500 font-medium italic mt-2 text-zinc-400">Previsão de fluxos tributários e <span class="text-amber-600 font-bold uppercase tracking-tighter">Reserva de Capital</span></p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 bg-white dark:bg-zinc-900 p-2.5 rounded-[1.8rem] border border-zinc-200 dark:border-zinc-800 shadow-sm">
                <flux:button href="{{ route('hub.business.dashboard') }}" variant="ghost" icon="arrow-left" wire:navigate title="Voltar" class="rounded-xl font-bold">Painel Business</flux:button>
            </div>
        </header>
    </div>

    {{-- 2. CENTRO DE PROVISÃO (ESTILO BLACK VAULT COM PRIVACIDADE) --}}
    <div class="stat-card bg-zinc-950 text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden border border-zinc-800 group transition-all hover:scale-[1.01]">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-12">
            <div class="space-y-6 flex-1 text-center lg:text-left">
                <div>
                    <p class="text-[10px] font-black uppercase tracking-[0.4em] text-amber-500 mb-2">Total de Provisão Recomendada</p>
                    <h2 class="text-6xl sm:text-7xl font-black tracking-tighter italic leading-none text-white">
                        ...
                        </span> <span class="text-3xl sm:text-4xl">€</span>
                    </h2>
                </div>
                <div class="p-5 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-md max-w-xl">
                    <p class="text-sm font-medium text-zinc-400 leading-relaxed">
                        Este é o montante estratégico que deves manter em <b>liquidez imediata</b> para cobrir IVA, TSU e a estimativa de IRC do período corrente.
                    </p>
                </div>
            </div>
            ...
            <div class="hidden lg:flex flex-col items-center gap-4">
                ...
                <p class="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-600">Audit Ready</p>
            </div>
        </div>
        <flux:icon name="receipt-percent" class="absolute -left-10 -bottom-10 size-48 text-white/5 -rotate-12" />
    </div>

    {{-- 3. GRID DE DETALHE POR OBRIGAÇÃO (AUDIT ANALYTICS COM PRIVACIDADE) --}}
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="glass-card p-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-sm flex flex-col justify-between group hover:border-brand-500/30 transition-all">
            <div>
                <div class="flex items-center justify-between mb-8">
                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Conta Corrente de IVA</h3>
                ...
                <div class="space-y-5">
                    <div class="flex justify-between items-center group/row">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-tight">IVA Liquidado</span>
                        </div>
                        <span :class="privacyMode ? 'blur-sm select-none' : ''" class="text-sm font-black text-red-500 transition-all duration-500">
                    ...
                    <div class="flex justify-between items-center group/row">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-tight">IVA Dedutível</span>
                        </div>
                        <span :class="privacyMode ? 'blur-sm select-none' : ''" class="text-sm font-black text-emerald-600 transition-all duration-500">
                    ...
                    <div class="pt-6 border-t border-zinc-100 dark:border-zinc-800 flex justify-between items-end">
                        <div>
                            <p class="text-[9px] font-black uppercase text-zinc-400 tracking-widest">Saldo devedor</p>
                            <p class="text-[10px] font-black dark:text-white uppercase mt-1">IVA a Pagar</p>
                        </div>
                        <span :class="privacyMode ? 'blur-md select-none' : ''" class="text-2xl font-black dark:text-white tracking-tighter italic transition-all duration-500">
        ...
        <div class="glass-card p-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-sm flex flex-col justify-between group hover:border-amber-500/30 transition-all">
            <div>
                <div class="flex items-center justify-between mb-8">
                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Segurança Social (TSU)</h3>
                ...
                <div>
                    ...
                    <p class="text-[9px] text-zinc-500 font-bold uppercase mt-4 tracking-widest leading-relaxed">
                        Estimativa de 23,75% sobre o <br> volume total da folha salarial.
                    </p>
                </div>
            </div>

            <div class="mt-8 pt-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                <span class="text-[9px] font-black text-zinc-400 uppercase tracking-widest">Prazo Limite</span>
        ...
        <div class="glass-card p-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-sm flex flex-col justify-between group hover:border-brand-500/30 transition-all">
            <div>
                <div class="flex items-center justify-between mb-8">
                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Provisão de IRC</h3>
                    <div class="p-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-zinc-500">
            ...
            <div class="mt-8">
                <div class="p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800">
                    <p class="text-[8px] font-black text-zinc-500 uppercase leading-none text-center">Reserva para encerramento de exercício</p>
                </div>
            </div>
        </div>
    </div>
