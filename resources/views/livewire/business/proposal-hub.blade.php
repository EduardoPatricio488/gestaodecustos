<div class="space-y-10 pb-20">
    ...
    <div class="relative">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            <div class="flex items-center gap-6">
                ...
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <flux:badge
                            variant="neutral"
                            class="bg-indigo-500/10 text-indigo-600 text-[9px] font-black uppercase tracking-widest border-none px-3 py-1">
                            Pipeline Comercial
                        </flux:badge>
                    </div>
            ...
            <div class="flex items-center gap-3 bg-white dark:bg-zinc-900 p-2.5 rounded-[1.8rem] border border-zinc-200 dark:border-zinc-800 shadow-sm">
                ...
                <flux:button
                    href="{{ route('hub.business.dashboard') }}"
                    variant="ghost"
                    icon="arrow-left"
                    wire:navigate
                    title="Voltar"
        ...
        <div class="glass-card bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800 shadow-sm transition-all hover:border-brand-500/30">
            <div class="flex justify-between items-start mb-4">
                ...
                <flux:badge
                    ...
                    {{ $proposals->where('status', 'enviada')->count() }} Ativos
                </flux:badge>
            </div>
            <p class="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] mb-1">
                Aguardar Resposta
    ...
    <div class="glass-card p-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl flex flex-col md:flex-row gap-4 shadow-sm items-center">
        <div class="relative flex-1 w-full">
            <flux:input
                ...
                placeholder="Procurar referência, título ou cliente..."
    ...
    <div class="glass-card bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-sm overflow-hidden group">
        <div class="p-8 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between bg-zinc-50/30 dark:bg-zinc-900/30">
            ...
            <flux:badge
                variant="neutral"
                class="bg-zinc-100 dark:bg-zinc-800 text-[10px] font-black uppercase px-3 py-1 border-none">
                {{ $proposals->count() }} Registos
            </flux:badge>
        </div>
                            ...
                            <td class="p-6 text-right pr-8">
                                <div class="flex items-center justify-end gap-3">
                                    @if($prop->status === 'aceite')
                                        <flux:button
                                            wire:click="convertToInvoice({{ $prop->id }})"
                                            variant="filled"
                                            size="xs"
                                            icon="document-check"
                                            class="bg-emerald-600 hover:bg-emerald-500 text-white font-black uppercase text-[9px] px-4 py-1.5 rounded-xl shadow-lg shadow-emerald-500/20 transition-all hover:scale-105">
                                            Faturar Agora
                                        </flux:button>
                                    @endif
                                    ...
                                    <flux:dropdown>
                                        ...
                                        <flux:menu class="min-w-[200px] p-2">
                                            <flux:menu.item
                                                wire:click="edit({{ $prop->id }})"
                                                icon="pencil-square"
                                                class="font-bold text-xs">
                                                Editar Dados
                                            </flux:menu.item>
                                            <flux:menu.item
                                                wire:click="updateStatus({{ $prop->id }}, 'enviada')"
                                                icon="paper-airplane"
                                                class="font-bold text-xs">
                                                Enviada ao Cliente
                                            </flux:menu.item>
                                            <flux:menu.item
                                                wire:click="updateStatus({{ $prop->id }}, 'aceite')"
                                                icon="check"
                                                class="text-emerald-600 font-bold text-xs">
                                                Marcar Adjudicada
                                            </flux:menu.item>
                                            <flux:menu.item
                                                wire:click="updateStatus({{ $prop->id }}, 'recusada')"
                                                icon="x-mark"
                                            ...
                                            <flux:menu.item
                                                ...
                                                wire:confirm="Eliminar oportunidade?"
                                                variant="danger"
                                                icon="trash"
                                                class="font-bold text-xs">
                                                Eliminar do Funil
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <flux:select
                            ...
                            class="font-bold uppercase text-[10px] !bg-zinc-50 dark:!bg-zinc-900 !border-none rounded-2xl h-14 shadow-inner">
                    ...
                    <div class="space-y-2">
                        ...
                        <flux:select
                            wire:model="status"
                            class="font-black uppercase text-[10px] !bg-zinc-50 dark:!bg-zinc-900 !border-none rounded-2xl h-14 shadow-inner">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <flux:input
                                ...
                                type="date"
                                class="font-bold !bg-white dark:!bg-zinc-950 !border-none rounded-xl h-14 shadow-sm"
                            />
                        </div>
                    </div>
