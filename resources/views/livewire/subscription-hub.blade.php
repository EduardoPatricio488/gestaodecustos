...
>
    ...
    >
        ...
        <div
            ...
            class="relative z-10 w-full max-w-2xl bg-white dark:bg-zinc-950 rounded-2xl shadow-xl
                   border border-zinc-200 dark:border-zinc-800 overflow-hidden transform-gpu"
            @click.stop
        >
            ...
            <form wire:submit.prevent="save" class="flex max-h-[86vh] flex-col" autocomplete="off">
                ...
                {{-- HEADER --}}
                <div class="shrink-0 p-5 sm:p-6 pb-4 flex items-center gap-4
                            border-b border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-950">
                    ...
                    <div class="flex-1 min-w-0">
                        <flux:heading size="lg"
                            class="font-black uppercase italic tracking-tight leading-none text-zinc-900 dark:text-white">
                ...
                <div class="min-h-0 flex-1 overflow-y-auto custom-scrollbar p-5 sm:p-6 space-y-5">
                    ...
                    <label class="block space-y-2">
                        ...
                        <input wire:model="name" type="text"
                            ...
                            class="w-full h-14 rounded-2xl border-0 bg-zinc-50 px-4 text-sm font-bold
                                   shadow-inner outline-none ring-0 transition
                                   focus:ring-2 focus:ring-brand-500/40 dark:bg-zinc-900 dark:text-white">
                    </label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <label class="block space-y-2">
                            ...
                            <input wire:model="amount" type="number" step="0.01" min="0"
                                placeholder="12.99"
                                class="w-full h-14 rounded-2xl border-0 bg-zinc-50 px-4 text-sm font-black
                                       text-brand-600 shadow-inner outline-none ring-0 transition
                                       focus:ring-2 focus:ring-brand-500/40 dark:bg-zinc-900">
                        </label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <label class="block space-y-2">
                            <span class="text-[10px] font-black uppercase tracking-widest text-zinc-500">Início</span>
                        ...
                        <label class="block space-y-2">
                            <span class="text-[10px] font-black uppercase tracking-widest text-zinc-500">Renovação</span>
                    ...
                    <label class="block space-y-2">
                        ...
                        <textarea wire:model="notes" rows="3"
                            ...
                            class="w-full resize-none rounded-2xl border-0 bg-zinc-50 px-4 py-3 text-sm font-bold
                                   shadow-inner outline-none ring-0 transition
                                   focus:ring-2 focus:ring-brand-500/40 dark:bg-zinc-900 dark:text-white"></textarea>
                    </label>
                    ...
                    <div class="rounded-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-4 space-y-3">
                        ...
                        <label class="block space-y-2">
                            ...
                            <input wire:model="notify_days_before" type="number" min="1" max="30"
                                placeholder="3"
                                class="w-full h-12 rounded-2xl border-0 bg-white px-4 text-sm font-black
                                       shadow-inner outline-none ring-0 transition
                                       focus:ring-2 focus:ring-brand-500/40 dark:bg-zinc-950 dark:text-white">
                        </label>
                    </div>
                </div>

                {{-- FOOTER (Responsivo) --}}
                <div class="shrink-0 p-5 sm:p-6 pt-4 flex flex-col sm:flex-row gap-3
                            border-t border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-950">

                    {{-- Cancelar --}}
                    <button
                        type="button"
                        @click="close()"
                        class="w-full h-16 sm:h-14 rounded-2xl text-zinc-500 hover:text-zinc-800
                    ...
                    <button
                        ...
                        wire:target="save"
                        class="w-full h-16 sm:h-14 rounded-2xl bg-emerald-600 hover:bg-emerald-700
                               text-white font-black uppercase tracking-widest shadow-xl
                               shadow-emerald-500/20 transition-all text-xs active:scale-95
                               disabled:opacity-60">
