        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-orange-500 via-red-500 to-pink-600 p-8 rounded-[2.5rem] shadow-2xl shadow-orange-500/20 border border-orange-400/20 mb-8">
            ...
            <div class="relative z-10 flex items-center justify-between gap-6">
                <div>
                    ...
                    <h2 class="text-2xl font-black text-white italic leading-tight max-w-2xl">"{{ $dailyQuote }}"</h2>
                </div>
                @if($streak > 0)
                    <div class="flex-shrink-0 flex flex-col items-center justify-center size-24 rounded-[2rem] bg-white/10 border border-white/20 backdrop-blur-md">
                        ...
                        <span class="text-2xl font-black text-white leading-none mt-1">{{ $streak }}</span>
