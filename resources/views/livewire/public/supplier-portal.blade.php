<div class="w-full max-w-lg bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 sm:p-14 rounded-[3.5rem] shadow-2xl backdrop-blur-md space-y-8 relative mx-auto" x-data="{ open: false }">
