<section class="space-y-6 text-left">
    <header>
        <flux:heading size="lg" class="font-black">Relatório Mensal por Email</flux:heading>
        <flux:subheading>Recebe automaticamente o PDF com resumo financeiro todos os meses.</flux:subheading>
    </header>
